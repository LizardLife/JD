...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.selectionStyle=UITableViewCellSelectionStyleNone;
    CategoryMenuModel * title=self.allData[indexPath.row];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.isRecordLastScroll) {
        [self.rightCollection scrollRectToVisible:CGRectMake(0, title.offsetScrorller, self.rightCollection.frame.size.width, self.rightCollection.frame.size.height) animated:NO];
    }
    else{
...
-(NSInteger)numberOfSectionsInCollectionView:(UICollectionView *)collectionView{
    ...
    CategoryMenuModel * title=self.allData[self.selectIndex];
...
-(NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section{
    ...
    if (title.nextArray.count>0) {
        ...
        CategoryMenuModel *sub=title.nextArray[section];
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CategoryMenuModel * title=self.allData[self.selectIndex];
    CategoryMenuModel * meun=title.nextArray[indexPath.section];
...
-(void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate
{
    if ([scrollView isEqual:self.rightCollection]) {
        ...
        CategoryMenuModel * title=self.allData[self.selectIndex];
        title.offsetScrorller=scrollView.contentOffset.y;
        self.isReturnLastOffset=NO;
